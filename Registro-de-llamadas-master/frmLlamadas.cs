...
namespace Registro_de_llamadas
{
    ...
    {
        #region Inicializar FormularioLlamadas
        public frmLlamadas()
        {
            InitializeComponent();
        }
        ...
        #region tsSalir Click
        private void tsSalir_Click(object sender, EventArgs e)
        {
            DialogResult r = MessageBox.Show("Esta seguro de salir?", "Llamadas",
                MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
            if (r == DialogResult.Yes) this.Close();
        }
        #endregion

        #region txtMinutos Click
